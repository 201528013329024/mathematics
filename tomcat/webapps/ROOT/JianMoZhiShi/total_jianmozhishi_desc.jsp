...
<a href="../JianMoZhiShi/total_jianmozhishi_desc.jsp?page=1">第一页</a>&nbsp;&nbsp;

<a href="../JianMoZhiShi/total_jianmozhishi_desc.jsp?page=<%=showpage-1 %>">上一页</a>&nbsp;&nbsp;

<a href="../JianMoZhiShi/total_jianmozhishi_desc.jsp?page=<%=showpage+1 %>">下一页</a> &nbsp;&nbsp;

 <a href="../JianMoZhiShi/total_jianmozhishi_desc.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
