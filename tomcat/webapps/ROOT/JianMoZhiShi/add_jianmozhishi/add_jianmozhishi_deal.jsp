...
<%
			...
			String sql = "insert into jianmozhishi values (null,?,?,?,?)";
...
if(!title.equals("")&&!content.equals("")&&!adder.equals("")&&!add_time.equals(""))  {
			pstmt.executeUpdate();
	                ...
	                out.println("<script language='javascript'>alert('信息填写不完整！请重新添加！');window.location.href='add_jianmozhishi.jsp';</script>");	
}	
