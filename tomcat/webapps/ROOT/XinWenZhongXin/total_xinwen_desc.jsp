...
<td>
	<% 
		   ...
		   catch(ClassNotFoundException e)
		   {
			...
			rs = stmt.executeQuery("select * from xinwen order by time desc");
...
for(int i=1; i<=pagesize; i++) {
	   ...
	   out.print("<td width='700' id='x2'>");
			...
			String s="XinWenZhongXin/add_xinwen/xinwen_desc.jsp?id="+idd+" ";
...
<a href="../XinWenZhongXin/total_xinwen_desc.jsp?page=1">第一页</a>&nbsp;&nbsp;

<a href="../XinWenZhongXin/total_xinwen_desc.jsp?page=<%=showpage-1 %>">上一页</a>&nbsp;&nbsp;

<a href="../XinWenZhongXin/total_xinwen_desc.jsp?page=<%=showpage+1 %>">下一页</a> &nbsp;&nbsp;

 <a href="../XinWenZhongXin/total_xinwen_desc.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
