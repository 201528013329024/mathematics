...
<html>
	...
	<body>
			<form name="form1" action="add_xinwen_deal.jsp" method="post" ENCTYPE="multipart/form-data">
			...
			<table width="1000" height="683" border="1" align="center">
				...
				<tr>
					...
					<td width="463" >
						<input id="x1" type="text" name="xinwen_title">
					</td>
				...
				<tr>
					...
					<td width="563">
						<textarea id="x2" style="width:900px;height:700px;" name="xinwen_main"  wrap="hard" ></textarea>
					</td>
				</tr>
...
<input type="file" name="pic_url">
				...
				<tr>
					...
					<td width="463">
						<input id="x2" type="text" name="picture_title">
					</td>
