	...
	<body>
			...
			<table width="1000" height="683" border="1" align="center">
				...
				<tr>
					...
					<td width="463" >
						<input id="x1" type="text" name="jianmoshiti_title">
					</td>
				...
				<tr>
					...
					<td width="563">
						<textarea id="x2" style="width:900px;height:700px;" name="jianmoshiti_main"  wrap="hard" ></textarea>
					</td>
				</tr>
