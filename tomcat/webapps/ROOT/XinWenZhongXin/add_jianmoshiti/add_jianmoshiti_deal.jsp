...
<%
			...
			String sql = "insert into jianmotimu values (null,?,?,?,?)";
			PreparedStatement pstmt = conn.prepareStatement(sql);
			
           
                        String title = request.getParameter("jianmoshiti_title"); 
			String content = request.getParameter("jianmoshiti_main");
...
if(!bmjj.equals("")&&!bz.equals("")&&!bmls.equals("")&&!adder.equals("")&&!add_time.equals(""))  {
			pstmt.executeUpdate();
	                ...
	                out.println("<script language='javascript'>alert('信息填写不完整！请重新添加！');window.location.href='add_jianmoshiti.jsp';</script>");	
}				%>
	</body>
