	...
	<body>
		...
		int rowcount=0;
			...
			try {
				...
				out.print("<td align='center'>密码</td>");
				...
				out.print("<td align='center'>删除会员</td>");
				out.print("</tr>");
...
<a href="HuiYuan_delete.jsp?page=1">第一页</a>&nbsp;&nbsp;

<a href="HuiYuan_delete.jsp?page=<%=showpage-1 %>">上一页</a>&nbsp;&nbsp;

<a href="HuiYuan_delete.jsp?page=<%=showpage+1 %>">下一页</a> &nbsp;&nbsp;

 <a href="HuiYuan_delete.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
