...
<html>
	...
	<body>
			<form name="form1" action="add_xuanchuanbu_deal.jsp" method="post">
			...
			<table width="800" height="683" border="1" align="center">
				<tr>
					<td colspan="2" height="30" >
						<center>
							更新前台宣传部简介<br><br>
						<a href="update.jsp">！--更新前请点击我删除旧的宣传部信息--！</a>
						</center>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="500">
						<input id="x1" type="text" name="buzhang">
					</td>
				...
				<tr>
					...
					<td width="500">
						<textarea id="x2" style="width:300px;height:200px;" name="bumenlishi"  wrap="hard" ></textarea>
					</td>
				</tr>
