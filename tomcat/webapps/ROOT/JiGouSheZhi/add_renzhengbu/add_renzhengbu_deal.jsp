...
<%
			...
			String sql = "insert into renzhengbu values (null,?,?,?,?,?)";
...
if(!bmjj.equals("")&&!bz.equals("")&&!bmls.equals("")&&!adder.equals("")&&!add_time.equals(""))  {
			pstmt.executeUpdate();
	                ...
	                out.println("<script language='javascript'>alert('信息填写不完整！请重新添加！');window.location.href='add_renzhengbu.jsp';</script>");	
}
			%>
	</body>
