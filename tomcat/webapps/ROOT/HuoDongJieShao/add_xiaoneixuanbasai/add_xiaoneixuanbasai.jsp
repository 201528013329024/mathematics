...
<html>
	...
	<body>
			<form name="form1" action="add_xiaoneixuanbasai_deal.jsp" method="post">
	
			<table width="1000" height="683" border="1" align="center">
				<tr>
					<td colspan="2" height="30" >
						<center>
							更新前台数学建模校内选拔赛介绍<br><br>
						<a href="update.jsp">！--更新前请点击我删除旧的数学建模校内选拔赛介绍信息--！</a>
						</center>
					</td>
				</tr>
