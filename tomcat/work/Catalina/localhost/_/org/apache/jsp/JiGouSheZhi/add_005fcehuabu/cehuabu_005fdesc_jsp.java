package org.apache.jsp.JiGouSheZhi.add_005fcehuabu;
...
public final class cehuabu_005fdesc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	  ...
	  rs = stmt.executeQuery("select * from cehuabu where id='"+id+"' ");
