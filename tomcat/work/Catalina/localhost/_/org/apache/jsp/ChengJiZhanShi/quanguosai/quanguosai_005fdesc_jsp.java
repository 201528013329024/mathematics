package org.apache.jsp.ChengJiZhanShi.quanguosai;
...
public final class quanguosai_005fdesc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	  ...
	  rs = stmt.executeQuery("select * from quanguosai_Grade where id='"+id+"' ");
