package org.apache.jsp.JiGouSheZhi.add_005fwailianbu;
...
public final class wailianbu_005fdesc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	  ...
	  rs = stmt.executeQuery("select * from wailianbu where id='"+id+"' ");
