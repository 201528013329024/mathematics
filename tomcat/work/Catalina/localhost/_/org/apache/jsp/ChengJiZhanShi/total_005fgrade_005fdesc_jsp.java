package org.apache.jsp.ChengJiZhanShi;
...
public final class total_005fgrade_005fdesc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t<img src=\"../photo/cjzs_1.jpg\"></img>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("</tr>\r\n");
      out.write("<tr>\r\n");
      ...
      out.write("\t");
		   ...
		   catch(ClassNotFoundException e)
		   {
			...
			rs = stmt.executeQuery("select * from quanguosai_Grade order by time desc");
...
for(int i=1; i<=pagesize; i++) {
	   ...
	   out.print("<td width='700' id='x2'>");
			...
			String s="ChengJiZhanShi/quanguosai/quanguosai_desc.jsp?id="+idd+" ";
...
out.print(rs.getString("time")); 
      ...
      out.write("]&nbsp;\r\n");
      out.write("\r\n");
      out.write("<a href=\"../ChengJiZhanShi/total_grade_desc.jsp?page=1\">第一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("<a href=\"../ChengJiZhanShi/total_grade_desc.jsp?page=");
